...
const BasketProduct = sequelize.define('basket_product', {
    ...
    size_product: {type: DataTypes.INTEGER, primaryKey: true},
    productId: {type: DataTypes.INTEGER, primaryKey: true},
    basketId: {type: DataTypes.INTEGER, primaryKey: true},
}, {
    uniqueKeys: {
        Items_unique: {
            fields: ['basketId', 'productId', 'size_product']
        }
    }
   }
)
...
// Характеристики -- свойства товара, у одного товара может быть много свойств
...
const OrderItem = sequelize.define('order_item', {
    ...
    size_product: {type: DataTypes.INTEGER, allowNull: false},
})

// связь many-to-many товаров и корзин через промежуточную таблицу basket_products;
// товар может быть в несколькbelongsToManyих корзинах, в корзине может быть несколько товаров
Basket.belongsToMany(Product, { through: BasketProduct, onDelete: 'CASCADE', unique: false});
Product.belongsToMany(Basket, { through: BasketProduct, onDelete: 'CASCADE', unique: false});
